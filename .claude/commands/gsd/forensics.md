...
<execution_context>
@M:/Prince-Picker-main/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @M:/Prince-Picker-main/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
