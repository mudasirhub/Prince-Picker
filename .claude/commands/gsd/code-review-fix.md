...
<execution_context>
@M:/Prince-Picker-main/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @M:/Prince-Picker-main/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
