...
Intel system is disabled. To activate:
  ...
  node M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs
