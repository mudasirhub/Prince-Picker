...
<execution_context>
@M:/Prince-Picker-main/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @M:/Prince-Picker-main/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
