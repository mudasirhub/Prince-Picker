...
See M:/Prince-Picker-main/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using M:/Prince-Picker-main/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using M:/Prince-Picker-main/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from M:/Prince-Picker-main/.claude/get-shit-done/templates/discovery.md
...
Use M:/Prince-Picker-main/.claude/get-shit-done/templates/discovery.md.
