...
<!-- For checkpoint task examples and patterns, see @M:/Prince-Picker-main/.claude/get-shit-done/references/checkpoints.md -->
...
See `M:/Prince-Picker-main/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `M:/Prince-Picker-main/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `M:/Prince-Picker-main/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
