...
<reference>
@M:/Prince-Picker-main/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `M:/Prince-Picker-main/.claude/get-shit-done/references/user-profiling.md` to load:
