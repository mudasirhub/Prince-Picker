...
Reference full template: `M:/Prince-Picker-main/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `M:/Prince-Picker-main/.claude/get-shit-done/templates/state.md`.
