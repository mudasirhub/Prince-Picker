...
Use template from `M:/Prince-Picker-main/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `M:/Prince-Picker-main/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
