...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = M:/Prince-Picker-main/.claude
                  → checks M:/Prince-Picker-main/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = M:/Prince-Picker-main/.claude/get-shit-done
                  → writes to M:/Prince-Picker-main/.claude/get-shit-done/hooks/
...
@M:/Prince-Picker-main/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @M:/Prince-Picker-main/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "M:/Prince-Picker-main/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
